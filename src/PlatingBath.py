...
def main():
    ...
    # Load Data
    train_data, test_data = LoadData_PlatingBath.load_data()
...
if False:
    ...
    Visualization.plot_normalization_comparison(
        ...
        n_samples=5, sample_indices=[0, 8000, 16000, 24000, 32000],
        n_sensors=4, sensor_indices=[0, 1, 2, 3],
    ...
    MODEL = "CNN"
    LR_TOP_K = None            # LR feature selection 크기. None이면 selection 안 함 (PlatingBath는 feature 4개라 selection 의미 없음)
